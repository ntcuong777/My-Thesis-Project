...
def main(run_args):
    ...
    if run_args.load_saved_dataloader:
        ...
        train_dataloader = DataLoader(train_data, args.batch_size, num_workers=args.num_workers, shuffle=True)
        eval_dataloader = DataLoader(eval_data, batch_size=64, num_workers=args.num_workers, shuffle=False)
    else:
