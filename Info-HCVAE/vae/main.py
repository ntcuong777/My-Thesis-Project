...
if __name__ == "__main__":
    ...
    parser.add_argument('--lambda_mmd_q', type=float, default=7700.0)
    parser.add_argument('--lambda_mmd_a', type=float, default=11700.0)
    # parser.add_argument('--alpha_jsd', type=float, default=0.0)
