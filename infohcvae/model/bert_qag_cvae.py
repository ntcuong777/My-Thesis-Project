...
class BertQAGConditionalVae(pl.LightningModule):
    def __init__(self, args):
        ...
        self.posterior_encoder = PosteriorEncoder(embedding, d_model, encoder_nhidden, encoder_nlayers,
                                                  ...
                                                  pad_token_id=self.pad_token_id, use_attention=False)
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument("--lambda_mmd_q", type=float, default=0)
        parser.add_argument("--lambda_mmd_a", type=float, default=0)
